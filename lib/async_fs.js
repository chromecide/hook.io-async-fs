...
async_fs.prototype.watchFile = function watchTree_asyncFs(options) {
var self = this;
  ...
  isDirTest_asyncFs(options.path, options.path, function(err, filename){
 ...
 *
 */
function isDirTest_asyncFs(filename, file_path, callback) {
